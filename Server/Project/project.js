...
app.get('/', (req, res) => {
    ...
    const data = [
        ...
        },
        {
            ...
            description:"Welcome to Website Market, your go-to platform for buying and selling website code! Whether you're a developer looking to monetize your web projects or a business owner in need of a fully functional website.",
        }
    ]
