...
app.get("/", async(req, res) => {
  ...
  const files = [
    {
      _id: 1,
      file_name: "Basic",
      file_path:"Public/SQL/code/01.Basic.sql",
  ...
  topics: [
    ...
    },
    {
      ...
      file_path: "Public/SQL/code/02.constraints.sql",
      explanation:
    ...
    },
    {
      ...
      file_path: "Public/SQL/code/03.DML.sql",
      explanation:
    ...
    },
    {
      _id: 4,
      file_name: "Sub Query",
      file_path: "Public/SQL/code/04.Sub query.sql",
    ...
    },
    {
      ...
      file_path: "Public/SQL/code/05.DDL.sql",
      explanation:
    ...
    },
    {
      ...
      file_path: "Public/SQL/code/06.TCL.sql",
      explanation:
    ...
    },
    {
      ...
      file_path: "Public/SQL/code/07.Numerical function.sql",
    ...
    },
    {
      ...
      file_path: "Public/SQL/code/08.Aggregate function.sql",
