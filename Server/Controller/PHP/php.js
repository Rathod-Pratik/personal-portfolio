...
app.get("/",async (req,res) => {
  ...
  const files = [
    ...
    },
    {
      ...
      code: [
        {function_name:"Cookie", function_code:"Public/PHP/code/Cookie/Cookie.php"},
        {function_name:"Read Cookie ", function_code:"Public/PHP/code/Cookie/read_cookie.php", output:"https://personal-portfolio-images-of-rathod.s3.ap-south-1.amazonaws.com/php+Output/cookie.png",},
      ],
    ...
    },
    {
      ...
      file_name: "Session",
      code: [
        {output:"https://personal-portfolio-images-of-rathod.s3.ap-south-1.amazonaws.com/php+Output/Season-1.png", function_name:"session",function_code:"Public/PHP/code/Session/session.php"},
        {output:"https://personal-portfolio-images-of-rathod.s3.ap-south-1.amazonaws.com/php+Output/Season-2.png", function_name:"Destroy session",function_code:"Public/PHP/code/Destroy session in php/destroy session.php"},
        {output:"https://personal-portfolio-images-of-rathod.s3.ap-south-1.amazonaws.com/php+Output/season-3.png", function_name:"Get data from session",function_code:"Public/PHP/code/Get data from session/get date.php"},
      ],
      explanation:
