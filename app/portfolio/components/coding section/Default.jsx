...
const Default = () => {
  return (
      <div className="flex items-center justify-center mt-2 h-[80vh]">
              <div className="text-center p-8 sm:p-1 rounded-lg">
                <h1 className="text-4xl font-bold mb-4">
                  Welcome to My Coding Blog!
                </h1>
                <p className="text-lg sm:text-sm sm:mb-2 mb-6">
                  Dive into a world of coding tutorials, tips, and insights.
                </p>
