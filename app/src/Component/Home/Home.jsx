  ...
  return (
    ...
    <div className="container flex flex-col-reverse justify-center p-6 mx-auto sm:py-12 lg:py-24 lg:flex-row lg:justify-between">
      ...
      >
        ...
        <span className="text-purple-500 text-5xl mt-2 block">
          <Typewriter
            options={{
              delay: 75,
        ...
        <span className="mt-6 mb-8 text-lg sm:mb-12">
          I&apos;m A Web Developer having experience in creating websites with
          fully responsive design and handling backend development.
        </span>
      ...
      >
        <img
          src="https://personal-portfolio-images-of-rathod.s3.ap-south-1.amazonaws.com/public/personal-photo.jpg"
          alt=""
          className="h-[14rem] md:h-72 object-contain  sm:h-80 rounded-full lg:h-96 xl:h-112 2xl:h-128"
        />
      </div>
    </div>
  </section>
