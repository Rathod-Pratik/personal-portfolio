...
const CodeBlock = ({ selectedCodeData }) => {
  ...
  const getLanguage = (fileName = "") => {
    ...
    switch (ext) {
      ...
      case "cxx": return "cpp";
      case "h":
      case "hpp": return "cpp"; // Header files
      case "cs":
  ...
  return (
    <div id="scroll" className="px-4 pt-4 md:ml-4 rounded-md border-r w-full z-0 text-white">
      {selectedCodeData ? (
        <div>
  ...
  showLineNumbers
  wrapLongLines
  customStyle={{ borderRadius: "8px", padding: "1rem", fontSize: "14px" }}
>
